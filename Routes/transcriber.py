...
# Fallback: expects ASSEMBLY_AI_API_KEY in env
...
class AssemblyAIStreamingTranscriber:
    ...
    Supports overriding the API key per instance.
    """
    ...
    def __init__(
        ...
        # Use provided key if present, else fall back to global settings/env
        key_to_use = api_key or aai.settings.api_key
